...
# Added options around updates and gzips, hostname to backup file name
#
...
# Begin the backup process, should take about 45 minutes hour from 8Gb SD card to HDD.  GZIP takes _much_ longer
echo ""
